...
public class CookieRun {
	...
	class MyPanel extends JPanel {
		...
		public void gameStart(MapObject mo) {
			
			mapMove(); // 배경 발판 장애물 작동
...
//				buffg.drawImage(c1.getImage(), c1.getX(), c1.getY(), c1.getWidth(), c1.getHeight(), null);
		...
		private void makeMo() {
			...
			mo1 = new MapObject(
					new ImageIcon("testimg/backTest.png"),
					new ImageIcon("배경이미지2"),
					new ImageIcon("testimg/jelly1Test.png"),
					new ImageIcon("testimg/jelly2Test.png"),
					new ImageIcon("testimg/jelly3Test.png"),
					new ImageIcon("testimg/jellyHPTest.png"),
					new ImageIcon("testimg/effectTest.png"),
					new ImageIcon("testimg/footTest.png"),
					new ImageIcon("testimg/footTest2.png"),
					new ImageIcon("testimg/tacleTest10.png"),
					new ImageIcon("testimg/tacleTest20.png"),
					new ImageIcon("testimg/tacleTest30.png"),
		...
		private void initImageIcon(MapObject mo) {
			...
			// 배경 이미지
			backIc = mo.getBackIc(); // 제일 뒷 배경
			secondBackIc = mo.getSecondBackIc(); // 2번째 배경
