...
ResultSet myResultSet = stmt.executeQuery("SELECT * FROM customer");
%>
<html>
...
<table border = "1" cellspacing = "0" width = "400" bordercolor = "#9AD2F7"
		...
		<tr> 
			...
			<p align = "center">
			<span style = "font-size : 8pt;"><b>NAME</b></span></p>
			</td>
			<td width = "150" height = "20" bgcolor = "#D2E9F9">
			<p align = "center">
			<span style = "font-size : 8pt;"><b>ADDRESS</b></span></p>
			</td>
			<td width = "150" height = "20" bgcolor = "#D2E9F9">
			<p align = "center">
...
if(myResultSet != null) {
	while(myResultSet.next()){
		String W_CUSTID = Integer.toString(myResultSet.getInt("custid"));
		System.out.println(W_CUSTID);
...
%>
	<tr>
		<td width = "150" height = "20">
			...
			<a href="orderView.jsp?custid=<%=W_CUSTID%>">
			<font face = "돋움체" color = "black">
			<%=W_NAME%></font></a></span></p>
		</td>
		<td width = "150" height = "20">
